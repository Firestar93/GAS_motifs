...
if __name__ == "__main__":
    ...
    allSNPs_that_survived_acetylationFilter = pd.read_csv("C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\GAS_motifs\\found_SNPs\\PBMC_TCell\\SNPs_in_highAcetylation.vcf", sep='\t', comment='#', header=None)
