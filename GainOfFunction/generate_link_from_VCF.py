...
def build_config(snp_path: str):
    snps = [SNP(line) for line in open(snp_path, "r").readlines() if not line.startswith("#")]
    ...
    config = {
        ...
        "removedTissues": [],
        "investigatedSNPs": [
            snp.rsid.strip("'") for snp in snps
        ]
    }
...
if __name__ == "__main__":
    print(create_link_snps("C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\GAS_motifs\\GainOfFunction\\SNPs_in_highAcetylation_AND_immuneGenes_AND_correctSignTarget_CLEANED_upstreamLess10KB.vcf"))